...
def classification_model(df):
    ...
    #print(labels)
    df = df.drop(['change'], axis=1)
    df = df[['close','rel_pol','rel_tweet_pol']]
    #print(df.columns)
...
def classification(frame):
    pass
for pop in [2,7,12,17,22,27,32,37,42,47]:
    text = load_text_data(r"C:\Users\Acer\Documents\Python Scripts\ AAPL .csv",'messages')
    text1 = load_text_data(r"C:\Users\Acer\Downloads\Data\tweet_score\AAPL_tweet_score.csv",'text')
   
    #text_tweets = load_text_data(r"C:\Users\Acer\Downloads\Data\tweet_score\AAPL_tweet_score.csv",'text')
    #print(text)
    price = load_price_data(r"C:\Users\Acer\Downloads\Data\csv\AAPL.csv")
    ...
    frame['rel_tweet_pol'] = window_sentiment(frame,pop)
    ...
    frame = frame[['close','rel_pol','rel_tweet_pol','change']]
    frame = frame.dropna()
